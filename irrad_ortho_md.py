...
fix	        10 all npt temp 300 300 100 iso 0.0 0.0 1000
...
group non-pka   subtract all pka #

fix             10 all dt/reset 1 0.0001 0.5 0.05 units box   # variable dt
fix             11 all npt temp 300 300 1000000000000 iso 0 0 1000
...
fix             10 all npt temp 300 300 100 iso 0 0 1000
